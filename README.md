...
Here is a rule of thumb: **Whenever you are modifing an attribute of the model, use `before_validation`. If you are doing some other action, then use `before_save`.**
